...
import { DROP_AS_NEW_GROUP_ID } from '../lib/dndResolve';
...
export const Sidebar = memo(function Sidebar() {
  const { sidebar } = useTabsView();
  const emit = useEmit<TabsEvent>();
  const { groupIds, isDraggingTab } = sidebar;
      ...
      <div className="sidebar__footer">
        ...
        <div className="sidebar__footer-buttons">
          ...
          <button
            ...
            onClick={() => emit({ type: 'tabs/group-create-requested' })}
          >
            + New Group
          </button>
