...
> **Phase 4 開始 (2026-04-28〜)**: Unit P4-G (お気に入り改善) 完了。Unit P4-A (永続化 + Tab.title 構造分離) 完了。Unit P4-B-1 (D&D 拡張) 完了 (2026-04-25)。Unit P4-B-2 (Settings UI + frameless window + 背景透過) 完了 (2026-04-25)。
